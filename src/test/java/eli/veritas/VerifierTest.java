...
public class VerifierTest
{
    ...
    @Test public void testFailureWithValue_ifXorNotNull()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
                                                                    () -> Verifier.<Long>forChecking(VerifierTest.class).ifXorNotNull("testField1",
                                                                                                                                      null,
                                                                                                                                      "testField2",
                                                                                                                                      "",
                                                                                                                                      TEST_VALUE1)
                                                                                                                        .ifXorNotNull("testField3",
                                                                                                                                      "",
                                                                                                                                      "testField4",
                                                                                                                                      null,
                                                                                                                                      TEST_VALUE2)
        ...
        Assertions.assertEquals(String.format(
                "Assertion failed for fields: \"VerifierTest#testField1\" and \"VerifierTest#testField2\";\tExpected exactly 1 object to be non-null.%n"
                + "Assertion failed for fields: \"VerifierTest#testField3\" and \"VerifierTest#testField4\";\tExpected exactly 1 object to be non-null."),
                                ex.getMessage(),
                                "Unexpected exception message");
        final List<Long> expectedValues = new LinkedList<>();
        expectedValues.add(TEST_VALUE1);
    ...
    @Test public void testFailureWithValue_ifXorNull()
    {
        ...
        Assertions.assertEquals(String.format(
                "Assertion failed for fields: \"VerifierTest#testField1\" and \"VerifierTest#testField2\";\tExpected exactly 1 object to be null.%n"
                + "Assertion failed for fields: \"VerifierTest#testField3\" and \"VerifierTest#testField4\";\tExpected exactly 1 object to be null."),
                                ex.getMessage(),
                                "Unexpected exception message");
        final List<Long> expectedValues = new LinkedList<>();
        expectedValues.add(TEST_VALUE1);
    ...
    @Test public void testFailure_ifXorNotNull()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
                                                                    () -> Verifier.<Long>forChecking(VerifierTest.class).ifXorNotNull("testField1",
                                                                                                                                      null,
    ...
    @Test public void testSuccess_ifXorNotNull()
    {
        Verifier.<Long>forChecking(VerifierTest.class).ifXorNotNull("testField1", null, "testField2", null)
                                                      .ifXorNotNull("testField3", "", "testField4", "")
                                                      .throwing(CompositeExceptionTester::new);
    }
