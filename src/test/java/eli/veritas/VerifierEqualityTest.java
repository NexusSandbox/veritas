...
public class VerifierEqualityTest {
  ...
  @Test
  public void testFailureWithValue_ifEqualBoolean() {
    ...
    Assertions.assertEquals(String.format(
        "Assertion failed for field: \"VerifierTest#testField1\";\tActual[true] ≡ Expected[false].%n"
  ...
  @Test
  public void testFailureWithValue_ifEqualCollection() {
    ...
    Assertions.assertEquals(String.format(
        "Assertion failed for field: \"VerifierTest#testField1\";\tActual[[xxx]] ≡ Expected[[yyy]].%n"
  ...
  @Test
  public void testFailureWithValue_ifEqualInstant() {
  ...
  @Test
  public void testFailureWithValue_ifEqualLocalDate() {
  ...
  @Test
  public void testFailureWithValue_ifEqualNumeric() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifEqual("testField1",
            1,
            2,
    ...
    Assertions.assertEquals(
        "Assertion failed for field: \"VerifierTest#testField1\";\tActual[1] ≡ Expected[2].",
        ex.getMessage(),
        "Unexpected exception message");
    final List<Long> expectedValues = new LinkedList<>();
    expectedValues.add(TEST_VALUE1);
  ...
  @Test
  public void testFailureWithValue_ifEqualNumericWithError() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
    ...
    Assertions.assertEquals(
        "Assertion failed for field: \"VerifierTest#testField1\";\tActual[1.5] ± ε[0.5] ≡ Expected[2.5].",
        ex.getMessage(),
        "Unexpected exception message");
    final List<Long> expectedValues = new LinkedList<>();
    expectedValues.add(TEST_VALUE1);
  ...
  @Test
  public void testFailureWithValue_ifEqualString() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifEqual("testField1",
            "x",
            "X",
    ...
    Assertions.assertEquals(String.format(
        "Assertion failed for field: \"VerifierTest#testField1\";\tActual[\"x\"] ≡ Expected[\"X\"].%n"
  ...
  @Test
  public void testFailureWithValue_ifNotEqualBoolean() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
    ...
    Assertions.assertEquals(String.format(
        "Assertion failed for field: \"VerifierTest#testField1\";\tActual[true] ≠ Expected[true].%n"
  ...
  @Test
  public void testFailureWithValue_ifNotEqualCollection() {
    final List<String> testCollection = new LinkedList<>();
    testCollection.add("xxx");
    ...
    Assertions.assertEquals(
        "Assertion failed for field: \"VerifierTest#testField1\";\tActual[[xxx]] ≠ Expected[[xxx]].",
        ex.getMessage(),
        "Unexpected exception message");
    final List<Long> expectedValues = new LinkedList<>();
    expectedValues.add(TEST_VALUE1);
  ...
  @Test
  public void testFailureWithValue_ifNotEqualInstant() {
    final Instant future = Instant.MAX;
  ...
  @Test
  public void testFailureWithValue_ifNotEqualLocalDate() {
    final LocalDateTime future = LocalDateTime.MAX;
  ...
  @Test
  public void testFailureWithValue_ifNotEqualNumeric() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifNotEqual("testField1",
            1,
            1,
    ...
    Assertions.assertEquals(
        "Assertion failed for field: \"VerifierTest#testField1\";\tActual[1] ≠ Expected[1].",
        ex.getMessage(),
        "Unexpected exception message");
    final List<Long> expectedValues = new LinkedList<>();
    expectedValues.add(TEST_VALUE1);
  ...
  @Test
  public void testFailureWithValue_ifNotEqualNumericWithError() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
    ...
    Assertions.assertEquals(
        "Assertion failed for field: \"VerifierTest#testField1\";\tActual[1.5] ± ε[0.5] ≠ Expected[1.25].",
        ex.getMessage(),
        "Unexpected exception message");
    final List<Long> expectedValues = new LinkedList<>();
    expectedValues.add(TEST_VALUE1);
  ...
  @Test
  public void testFailureWithValue_ifNotEqualString() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifNotEqual("testField1",
            "x",
            "x",
  ...
  @Test
  public void testFailure_ifEqualBoolean() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifEqual("testField1",
            true,
            false)
  ...
  @Test
  public void testFailure_ifEqualCollection() {
    final List<String> testCollection = new LinkedList<>();
    testCollection.add("xxx");
    final List<String> expectedCollection1 = new LinkedList<>();
    expectedCollection1.add("yyy");
  ...
  @Test
  public void testFailure_ifEqualInstant() {
    final Instant future = Instant.MAX;
    final Instant past = Instant.MIN;
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifEqualDate("testField1",
  ...
  @Test
  public void testFailure_ifEqualLocalDate() {
    final LocalDateTime future = LocalDateTime.MAX;
    final LocalDateTime past = LocalDateTime.MIN;
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifEqualDate("testField1",
  ...
  @Test
  public void testFailure_ifEqualNumeric() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
  ...
  @Test
  public void testFailure_ifEqualNumericWithError() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifEqualWithError("testField1",
            1.5,
            2.5,
  ...
  @Test
  public void testFailure_ifEqualString() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifEqual("testField1",
            "x",
            "X",
  ...
  @Test
  public void testFailure_ifNotEqualBoolean() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifNotEqual("testField1",
            true,
            true)
  ...
  @Test
  public void testFailure_ifNotEqualCollection() {
    final List<String> testCollection = new LinkedList<>();
    testCollection.add("xxx");
    final List<String> expectedCollection = new LinkedList<>();
    expectedCollection.add("xxx");
  ...
  @Test
  public void testFailure_ifNotEqualInstant() {
    final Instant future = Instant.MAX;
    final Instant past = Instant.MAX.minus(1, ChronoUnit.SECONDS);
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifNotEqualDate("testField1",
  ...
  @Test
  public void testFailure_ifNotEqualLocalDate() {
    final LocalDateTime future = LocalDateTime.MAX;
    final LocalDateTime past = LocalDateTime.MAX.minus(1, ChronoUnit.SECONDS);
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifNotEqualDate("testField1",
  ...
  @Test
  public void testFailure_ifNotEqualNumeric() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifNotEqual("testField1",
            1,
            1)
  ...
  @Test
  public void testFailure_ifNotEqualNumericWithError() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifNotEqualWithError(
            "testField1",
            1.5,
  ...
  @Test
  public void testFailure_ifNotEqualString() {
    final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        () -> Verifier.<Long>forChecking(VerifierTest.class).ifNotEqual("testField1",
            "x",
            "x",
  ...
  @Test
  public void testSuccess_ifEqualBoolean() {
  ...
  @Test
  public void testSuccess_ifEqualCollection() {
    final List<String> testCollection = new LinkedList<>();
    testCollection.add("xxx");
    final List<String> expectedCollection = new LinkedList<>();
    expectedCollection.add("xxx");
    Verifier.<Long>forChecking(VerifierTest.class)
        .ifEqual("testField1", testCollection, expectedCollection)
        .throwing(CompositeExceptionTester::new);
  }

  @Test
  public void testSuccess_ifEqualInstant() {
    final Instant future = Instant.MAX;
    final Instant past = Instant.MAX.minus(1, ChronoUnit.SECONDS);
    Verifier.<Long>forChecking(VerifierTest.class).ifEqualDate("testField1", future, past, 5)
        .throwing(CompositeExceptionTester::new);
  }

  @Test
  public void testSuccess_ifEqualLocalDate() {
    final LocalDateTime future = LocalDateTime.MAX;
    final LocalDateTime past = LocalDateTime.MAX.minus(1, ChronoUnit.SECONDS);
    Verifier.<Long>forChecking(VerifierTest.class).ifEqualDate("testField1", future, past, 5)
        .throwing(CompositeExceptionTester::new);
  ...
  @Test
  public void testSuccess_ifEqualNumeric() {
    Verifier.<Long>forChecking(VerifierTest.class).ifEqual("testField1", 1, 1)
        .throwing(CompositeExceptionTester::new);
  }

  @Test
  public void testSuccess_ifEqualNumericWithError() {
    Verifier.<Long>forChecking(VerifierTest.class).ifEqualWithError("testField1", 1.5, 1.75, .5d)
        .throwing(CompositeExceptionTester::new);
  }

  @Test
  public void testSuccess_ifEqualString() {
  ...
  @Test
  public void testSuccess_ifNotEqualBoolean() {
  ...
  @Test
  public void testSuccess_ifNotEqualCollection() {
    final List<String> testCollection = new LinkedList<>();
    testCollection.add("xxx");
    final List<String> expectedCollection1 = new LinkedList<>();
    expectedCollection1.add("yyy");
    ...
    expectedCollection2.add("yyy");
    Verifier.<Long>forChecking(VerifierTest.class)
        .ifNotEqual("testField1", testCollection, expectedCollection1)
        .ifNotEqual("testField2", testCollection, expectedCollection2)
        .throwing(CompositeExceptionTester::new);
  }

  @Test
  public void testSuccess_ifNotEqualInstant() {
    final Instant future = Instant.MAX;
    final Instant past = Instant.MIN;
    Verifier.<Long>forChecking(VerifierTest.class).ifNotEqualDate("testField1", future, past, 5)
        .throwing(CompositeExceptionTester::new);
  }

  @Test
  public void testSuccess_ifNotEqualLocalDate() {
    final LocalDateTime future = LocalDateTime.MAX;
    final LocalDateTime past = LocalDateTime.MIN;
    Verifier.<Long>forChecking(VerifierTest.class).ifNotEqualDate("testField1", future, past, 5)
        .throwing(CompositeExceptionTester::new);
  ...
  @Test
  public void testSuccess_ifNotEqualNumeric() {
    Verifier.<Long>forChecking(VerifierTest.class).ifNotEqual("testField1", 1, 2)
        .throwing(CompositeExceptionTester::new);
  }

  @Test
  public void testSuccess_ifNotEqualNumericWithError() {
    Verifier.<Long>forChecking(VerifierTest.class).ifNotEqualWithError("testField1", 1.5, 2.25, .5d)
        .throwing(CompositeExceptionTester::new);
  }

  @Test
  public void testSuccess_ifNotEqualString() {
