...
public class VerifierStringTest
{
    ...
    @Test public void testFailureWithValue_ifBlank()
    {
        ...
        Assertions.assertEquals("Assertion failed for field: \"VerifierTest#testField1\";\tExpected string[\"xxx\"] to be blank, empty, or null.",
                                ex.getMessage(),
    ...
    @Test public void testFailureWithValue_ifEmpty()
    {
        ...
        Assertions.assertEquals("Assertion failed for field: \"VerifierTest#testField1\";\tExpected string[\"xxx\"] to be empty, or null.",
                                ex.getMessage(),
                                "Unexpected exception message");
        final List<Long> expectedValues = new LinkedList<>();
        expectedValues.add(TEST_VALUE1);
    ...
    @Test public void testFailureWithValue_ifMatches()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
    ...
    @Test public void testFailureWithValue_ifNotBlank()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
    ...
    @Test public void testFailureWithValue_ifNotEmpty()
    {
        ...
        Assertions.assertEquals(String.format("Assertion failed for field: \"VerifierTest#testField1\";\tExpected string to not be empty, or null.%n"
    ...
    @Test public void testFailureWithValue_ifNotMatches()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
    ...
    @Test public void testFailureWithValue_ifNotWithinMaxLength()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        ...
        Assertions.assertEquals("Assertion failed for field: \"VerifierTest#testField1\";\tExpected string[\"x\"] length[1] to exceed length[1].",
                                ex.getMessage(),
                                "Unexpected exception message");
        final List<Long> expectedValues = new LinkedList<>();
        expectedValues.add(TEST_VALUE1);
    ...
    @Test public void testFailureWithValue_ifWithinMaxLength()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
        ...
        Assertions.assertEquals("Assertion failed for field: \"VerifierTest#testField1\";\tExpected string[\"xx\"] length[2] to be within length[1].",
                                ex.getMessage(),
                                "Unexpected exception message");
        final List<Long> expectedValues = new LinkedList<>();
        expectedValues.add(TEST_VALUE1);
    ...
    @Test public void testFailure_ifBlank()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
    ...
    @Test public void testFailure_ifMatches()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
                                                                    () -> Verifier.<Long>forChecking(VerifierTest.class).ifMatches("testField1",
                                                                                                                                   "1984-Jan-23",
    ...
    @Test public void testFailure_ifNotBlank()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
                                                                    () -> Verifier.<Long>forChecking(VerifierTest.class).ifNotBlank("testField1",
                                                                                                                                    null)
    ...
    @Test public void testFailure_ifNotMatches()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
                                                                    () -> Verifier.<Long>forChecking(VerifierTest.class).ifNotMatches("testField1",
                                                                                                                                      "1984-01-23",
    ...
    @Test public void testFailure_ifNotWithinMaxLength()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
                                                                    () -> Verifier.<Long>forChecking(VerifierTest.class).ifNotWithinMaxLength(
                                                                            "testField1",
    ...
    @Test public void testFailure_ifWithinMaxLength()
    {
        final CompositeExceptionTester ex = Assertions.assertThrows(CompositeExceptionTester.class,
                                                                    () -> Verifier.<Long>forChecking(VerifierTest.class).ifWithinMaxLength(
                                                                            "testField1",
    ...
    @Test public void testSuccess_ifBlank()
    {
    ...
    @Test public void testSuccess_ifMatches()
    {
        Verifier.<Long>forChecking(VerifierTest.class).ifMatches("testField1", "1984-01-23", "\\d{4}-\\d{2}-\\d{2}")
                                                      .throwing(CompositeExceptionTester::new);
    }

    @Test public void testSuccess_ifNotBlank()
    {
        Verifier.<Long>forChecking(VerifierTest.class).ifNotBlank("testField1", "x").throwing(CompositeExceptionTester::new);
    }
    ...
    @Test public void testSuccess_ifNotMatches()
    {
        Verifier.<Long>forChecking(VerifierTest.class).ifNotMatches("testField1", "1984-Jan-23", "\\d{4}-\\d{2}-\\d{2}")
                                                      .throwing(CompositeExceptionTester::new);
    }

    @Test public void testSuccess_ifNotWithinMaxLength()
    {
        Verifier.<Long>forChecking(VerifierTest.class).ifNotWithinMaxLength("testField1", "xx", 1).throwing(CompositeExceptionTester::new);
    }

    @Test public void testSuccess_ifWithinMaxLength()
    {
        Verifier.<Long>forChecking(VerifierTest.class).ifWithinMaxLength("testField1", "x", 1).throwing(CompositeExceptionTester::new);
    }
}
